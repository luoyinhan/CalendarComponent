...
public abstract class MonthView extends View {
    ...
    private IScrollLeftRight scrollLeftRight;
     ...
     * 添加左右滑动回调函数
     */
    public interface IScrollLeftRight {
        void aciton(int year, int month);
    }
    ...
    public void setScrollLeftRight(IScrollLeftRight leftRight) {
        this.scrollLeftRight = leftRight;
    }
